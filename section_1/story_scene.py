...
def run_story(screen):
   #ศึกษาจากคลิปวิดีโอ https://www.youtube.com/playlist?list=PLhTjy8cBISEo3SzET7Fc3-b4miKWp41yX
   ...
   # เขียน flowchart + เอารูปเเบบมาจากไฟล์ menu_main.py และใช้ปัญญาประดิษฐ์ช่วย
   # STORY 1: รถจะชน
   ...
   dialog_lines = [
       ...
       "ชายปริศนา: ในบ้านร้างหลังนั้น...มีของบางอย่างที่ข้าต้องการ เจ้าจะต้องนำมันกลับมาให้ข้า",
       "สมชาย: ของ? อืม...ของมีค่าใช่มั้ย ถ้ามีค่าก็ว่ามาเลย ผมรับงานนะ แต่ขอถามหน่อย งานมีประกันชีวิตมั้ย?",
