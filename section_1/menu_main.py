...
#ศึกษาเองจากคลิปวิดีโอ https://www.youtube.com/watch?v=bmRFi7-gy5Y
pygame.init()
WIDTH , HEIGHT = 1500,850
screen = pygame.display.set_mode((WIDTH,HEIGHT))
pygame.display.set_caption("My Game - Menu")

#ศึกษาเองจากคลิปวิดีโอ https://www.youtube.com/playlist?list=PLhTjy8cBISEo3SzET7Fc3-b4miKWp41yX
#โหลดรูป เสียง
...
#ปรับเปลี่ยนจากคลิปต้นฉบับ https://www.youtube.com/watch?v=bmRFi7-gy5Y โดยใช้ปัญญาประดิษฐ์
def main():
    running = True
    while running:
