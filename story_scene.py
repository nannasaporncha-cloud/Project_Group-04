import pygame
from gameplay import run_main_game  # จบเนื้อเรื่องแล้วไปหน้าเกมจริง
...
# ฟอนต์
    thai_font = "image/assets/THsarabaneiei.ttf"
    font = pygame.font.Font(thai_font, 48)

# โหลดรูป
    car_bg = pygame.image.load("image/assets/story1_accident.png")
    car_bg = pygame.transform.scale(car_bg, (WIDTH, HEIGHT))
    white_bg = pygame.image.load("image/assets/story2.png")
    white_bg = pygame.transform.scale(white_bg, (WIDTH, HEIGHT))
    town_bg = pygame.image.load("image/assets/story3_reborn.png")
    town_bg = pygame.transform.scale(town_bg, (WIDTH, HEIGHT))

# โหลดเสียง 
    horn_sound = pygame.mixer.Sound("image/assets/car_horn.mp3")
    horn_sound.set_volume(0.6)
    pygame.mixer.music.load("image/assets/bgm_creepy.mp3")
...
# STORY 2: ฉากขาวเงียบ
    ...
    while in_scene2:
        ...
        hint_text = font.render("ที่นี่...ที่ไหน", True, BLACK)
